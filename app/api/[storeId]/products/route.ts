...
export async function POST(
  ...
  try {
    const params = await context.params;  // <-- ini yang wajib diawait
...
export async function GET(
  ...
  try {
    const params = await context.params; // <-- wajib diawait dulu
    ...
    if (!params.storeId) {
      return new NextResponse("Product id URL dibutuhkan");
    }
